<template>
	<el-form ref="form" :model="form" label-width="80px" @submit.prevent="onSubmit" style="margin:20px;width:60%;min-width:600px;">
		<el-form-item label="解答内容">
			<strong class="title">{{onewenti.afont}}</strong>
		</el-form-item>
		<!--<el-form-item label="解答图片">-->
			<!--<img :src=onewenti.aimg style="width:400px;height:400px;border-radius:5px;"/>-->
		<!--</el-form-item>-->
		<el-form-item label="解答视频">
		...
		<el-form-item>
			<el-button type="primary" @click="tiaozhuan">返回</el-button>
			...
			getMsg(){
                ...
                var _this = this;
                    instance({
                        ...
                        params:{
                            qId:this.$route.query.qId1
                        }
                    }).then(function (res) {
                        _this.onewenti=res.data.data
                        _this.playerOptions.sources[0].src=res.data.data.avideo
                    }).catch(function (err) {
                    })
			},
            tiaozhuan(){
