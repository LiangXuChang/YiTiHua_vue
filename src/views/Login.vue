<template>
  <el-form :model="ruleForm2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-button size="small" @click="handleSubmit2">切换至教师登陆</el-button>
  </el-form>
</template>
                ...
                if (valid) {
                    ...
                    instance({
                        ...
                        if(res.data.data.code != 0){
                            ...
                            // store.dispatch('permissions',res.data.Code)
                            this.queryParams={studentAccount:this.ruleForm2.account};
                            _this.$store.state.code1=true;
                            _this.$store.state.code3=true;
                            _this.$store.state.code2=false;
                            _this.$store.state.code4=false;
                            _this.$store.state.code5=false;
                            sessionStorage.setItem('user',JSON.stringify(this.queryParams))
                            // store.state.userID=res.data.Code
                            // console.log(store.state.userID)
